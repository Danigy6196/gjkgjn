...
userToken = ['OTEwNTM0MzA1NjgyNDIzODM4.YZUPJw.JLPhIq6l1pE31UNxvgXRVGAuLrw'] # User Tokens here. example 'token','token' | 'email:pass', 'token'
DiscordChannel = '897858679221657694' # Channel ID,
